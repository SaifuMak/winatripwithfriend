      ...
      <div className="lg:w-9/12 w-full min-h-[130dvh]  relative">
        ...
        <div className=" w-full h-full  absolute inset-0">
          <div className=" pt-10 2xl:pt-10 lg:w-6/12 sm:w-9/12 w-11/12  h-full mx-auto flex  flex-col items-center">
            ...
            <div className="w-fit  absolute  right-1  2xl:-right-12  xl:bottom-10 lg:bottom-36 bottom-0 size-[16%]  sm:size-[28%] lg:size-[32%] xl:size-[35%]   2xl:size-[37%]  ">
              <img src="/image/home/cola.png" alt="coke" className=" w-full h-full object-contain" />
            </div>

            <div className="2xl:w-[350px] lg:w-[300px] max-sm:w-[200px] h-fit  absolute bottom-1 sm:bottom-8 lg:bottom-28 xl:bottom-20 2xl:bottom-20 sm:left-5 left-2 lg:left-0 xl:left-5  ">
